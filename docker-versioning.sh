...
if [ -z $CHECKIMAGE ]; then
        ...
        sudo docker build -t rascalbrick/php-apache:$version -f web/Dockerfile .
        ...
        sudo docker run --name php-apache -p 80:80 --link mysql:mysql --link redis:redis -d rascalbrick/php-apache
